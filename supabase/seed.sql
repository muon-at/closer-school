...
insert into public.jobs (title, company, location, pay, type, description, tags) values
  ('TM-selger — Allente-partner', 'Nordic Salgspartner AS', 'Oslo (kontor) / hybrid', 'Fastlønn 220 000 + provisjon. Realistisk år 1: 420 000–550 000 kr', 'Fulltid', 'Ring varme og kalde lister for en av Nordens største TV- og bredbåndsaktører. Full opplæring, ung kultur, tydelig karrierevei mot teamleder.', '["Telefonsalg","B2C","Garanti-partner"]'),
